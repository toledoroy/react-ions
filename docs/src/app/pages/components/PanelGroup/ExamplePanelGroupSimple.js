...
const ExamplePanelGroupSimple = () => (
  <div>
    <PanelGroup accordion={true} optClass='simple'>
      <Panel>
        <PanelHeader title='Promoter' contextIcon='caret-bottom' contextIconSize='12' />
        <PanelContent>
      ...
      <Panel>
      <PanelHeader title='Passive' contextIcon='caret-bottom' contextIconSize='12' />
        <PanelContent>
          <h3>What happens after a promoter submits their score?</h3>
          <RadioGroup
            name="default-radio-group"
      ...
      <Panel>
      <PanelHeader title='Detractor' contextIcon='caret-bottom' contextIconSize='12' />
        <PanelContent>
        <h3>What happens after a promoter submits their score?</h3>
        <RadioGroup
          name="default-radio-group"
