...
class ExamplePanelCustom extends React.Component {
  constructor(props) {
    super(props);
  }
    ...
    return (
      <div>
        <PanelGroup activePanels={this.state.panels} onPanelToggle={this.panelToggle} optClass={'default'}>
          <Panel>
            <PanelHeader title='Rating' contextNode={<Icon name='icon-check-1-1' />} />
            <PanelContent>
              <p className={style.paragraph}>{this.state.content.lorum1}</p>
            </PanelContent>
          </Panel>
          <Panel>
            <PanelHeader title='Channel' contextNode={<Icon name='icon-power-1' />} />
            <PanelContent>
              <p className={style.paragraph}>{this.state.content.lorum2}</p>
            </PanelContent>
          </Panel>
          <Panel>
            <PanelHeader title='Date' contextNode={<Icon name='icon-check-1-1' />} />
            <PanelContent>
              <p className={style.paragraph}>{this.state.content.lorum3}</p>
            </PanelContent>
          </Panel>
          <Panel>
            <PanelHeader title='Location' contextNode={<Icon name='icon-check-1-1' />} />
            <PanelContent>
...
export default ExamplePanelCustom
