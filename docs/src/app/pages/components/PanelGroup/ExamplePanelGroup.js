...
class ExamplePanelGroup extends React.Component {
  constructor(props) {
    super(props);
  }
    ...
    return (
      <div>
        ...
        <PanelGroup activePanels={this.state.panels} onPanelToggle={this.panelToggle} optClass={'default'}>
          <Panel>
            <PanelHeader title='Rating' contextIcon='check-1-1' contextIconSize='14' />
            <PanelContent optClass={style['rating-specific']}>
              <p className={style.paragraph}>{this.state.content.lorum1}</p>
            </PanelContent>
          </Panel>
          <Panel>
            <PanelHeader title='Channel' contextIcon='check-1-1' contextIconSize='14' />
            <PanelContent>
              <p className={style.paragraph}>{this.state.content.lorum2}</p>
            </PanelContent>
          </Panel>
          <Panel>
            <PanelHeader title='Date' contextIcon='check-1-1' contextIconSize='14' />
            <PanelContent>
              <p className={style.paragraph}>{this.state.content.lorum3}</p>
            </PanelContent>
          </Panel>
          <Panel>
            <PanelHeader title='Location' contextIcon='check-1-1' contextIconSize='14' />
            <PanelContent>
