...
var list = {
  material: [
    ...
    materialPath + '/hardware/svg/production/ic_keyboard_arrow_down_24px.svg#md-arrow-down',
    materialPath + '/hardware/svg/production/ic_keyboard_arrow_up_24px.svg#md-arrow-up',
