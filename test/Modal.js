...
describe('Modal', () => {
  ...
  it('should render itself inside a div at the bottom of the document body', () => {
    ...
    expect(document.body.getElementsByClassName('modal-scroll-container')).to.have.length(1)
  ...
  it('should be displayed when the open property is set to true', () => {
    ...
    expect(document.body.getElementsByClassName('modal-component')[0].children[0].children[0].style.left).to.be.equal('0px')
    expect(document.body.getElementsByClassName('modal-component')[0].children[0].children[0].style.opacity).to.be.equal('0.6')
  })
  ...
  it('should close when the overlay is clicked', () => {
    ...
    eventFire(document.body.getElementsByClassName('modal-component')[0].children[0].children[0], 'click')
  ...
  it('should close when the close button is clicked', () => {
    ...
    eventFire(document.body.getElementsByClassName('modal-close')[0].children[0].children[0], 'click')
  ...
  it('should close the scroll container element is clicked', () => {
    const actions = [
      <button onClick={toggleModal.bind(this, false)}>Cancel</button>,
      <button onClick={toggleModal.bind(this, false)}>Submit</button>
    ]
    ...
    eventFire(document.body.getElementsByClassName('modal-scroll-container')[0], 'click')
