...
const componentsContext = require.context('../../src/components/', true, /^(?!\.\/index\.js)((?!__tests__).)*\.js$/)
const utilitiesContext = require.context('../../src/utilities/', true, /^(?!\.\/index\.js)((?!__tests__).)*\.js$/)
