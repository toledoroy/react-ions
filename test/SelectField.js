...
describe('SelectField', () => {
  ...
  it('should shallow render itself', () => {
    ...
    expect(wrapper.childAt(0).find('div')).to.have.length(2)
    expect(wrapper.childAt(0).find('input')).to.have.length(1)
    expect(wrapper.childAt(0).find('ul')).to.have.length(1)
    expect(wrapper.childAt(0).find('li')).to.have.length(2)
    expect(wrapper.childAt(0).find(Icon)).to.have.length(1)

    expect(wrapper.childAt(0).hasClass('selectfield-component')).to.equal(true)
    expect(wrapper.childAt(0).childAt(0).props().name).to.equal('selectfield-value')
    expect(wrapper.childAt(0).childAt(0).props().type).to.equal('hidden')
    expect(wrapper.childAt(0).childAt(0).props().value).to.equal('')
    expect(wrapper.childAt(0).childAt(1).text().indexOf('Please select an option')).to.equal(0)
    expect(wrapper.childAt(0).find(Icon).props().name).to.equal('icon-caret')
    expect(wrapper.childAt(0).find('ul').children()).to.have.length(2)
    expect(wrapper.childAt(0).find('ul').childAt(1).text()).to.equal(options[1].display)
    expect(wrapper.childAt(0).find('ul').childAt(1).text()).to.equal(options[1].display)
    expect(wrapper.childAt(0).hasClass('active')).to.equal(false)
  })
  ...
  it('should be disabled', () => {
    ...
    expect(wrapper.childAt(0).hasClass('selectfield-component')).to.equal(true)
    expect(wrapper.childAt(0).hasClass('selectfield-disabled')).to.equal(true)
    expect(wrapper.childAt(0).hasClass('active')).to.equal(false)
  })
  ...
  it('should have an extra class', () => {
    ...
    expect(wrapper.childAt(0).hasClass('selectfield-component')).to.equal(true)
    expect(wrapper.childAt(0).hasClass('selectfield-error')).to.equal(true)
  })
  ...
  it('should have a placeholder', () => {
    ...
    expect(wrapper.childAt(0).childAt(1).text().indexOf(placeholder)).to.equal(0)
  })

  it('should have an icon', () => {
    wrapper = shallow(<SelectField options={options} valueProp='value' displayProp='display' icon='icon-globe-1' />)

    expect(wrapper.childAt(0).hasClass('has-icon')).to.be.true
    expect(wrapper.childAt(0).find('.icon')).to.have.length(1)
  })
  ...
  it('should have an icon for each option', () => {
    ...
    expect(wrapper.childAt(0).find('.icon')).to.have.length(2)
    expect(wrapper.childAt(0).find('ul').childAt(0).find(Icon)).to.have.length(1)
    expect(wrapper.childAt(0).find('ul').childAt(0).find(Icon).props().name).to.equal('icon-megaphone-1')
    expect(wrapper.childAt(0).find('ul').childAt(1).find(Icon)).to.have.length(1)
    expect(wrapper.childAt(0).find('ul').childAt(1).find(Icon).props().name).to.equal('icon-slack-1')
    expect(wrapper.childAt(0).find('ul').childAt(1).find(Icon).props().fill).to.equal('#3C97D3')
  ...
  it('should have an option selected by default', () => {
    ...
    expect(wrapper.childAt(0).childAt(1).text().indexOf(optionsWithIcons[1].display)).to.not.equal(-1)
  })
  ...
  it('should toggle the select field isOpen state', () => {
    ...
    expect(wrapper.childAt(0).hasClass('active')).to.equal(true)
  })
  ...
  it('should change the option', () => {
    ...
    expect(wrapper.childAt(0).childAt(1).text().indexOf(options[1].display)).to.equal(0)
  })
  ...
  it('should update the state when the value property changes', () => {
    ...
    expect(wrapper.childAt(0).childAt(1).text().indexOf(optionsAltValueProp[0].display)).to.equal(0)

    wrapper.setProps({ value: '1' })
    wrapper.update()

    expect(wrapper.childAt(0).childAt(1).text().indexOf(optionsAltValueProp[1].display)).to.equal(0)
  })
  ...
  it('should show a message when there are no options to select', () => {
    ...
    expect(wrapper.childAt(0).childAt(2).childAt(0).text()).to.equal('Nothing to select')
  })
})
