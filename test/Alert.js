...
describe('Alert', () => {
  ...
  it('should display a default alert (success)', () => {
    ...
    expect(wrapper.find('[name="check"]')).to.have.length(1)
  })
  ...
  it('should display a warning alert', () => {
    ...
    expect(wrapper.find('[name="warning"]')).to.have.length(1)
  })
  ...
  it('should display an info alert', () => {
    ...
    expect(wrapper.find('[name="info"]')).to.have.length(1)
  })
  ...
  it('should display a danger alert', () => {
    ...
    expect(wrapper.find('[name="x"]')).to.have.length(1)
  })
